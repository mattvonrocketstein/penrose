...
class Canvas(object):
    ...
    def __init__(self, IMAGE_SIZE, NUM_SUBDIVISIONS):
        """ """
    ...
    def render(self, triangles=[]):
        triangles=triangles or get_triangles(self.NUM_SUBDIVISIONS)
...
def get_triangles(NUM_SUBDIVISIONS):
